...
CONTEXT_FIELDS = (
    ...
    "Activity_Type", "LaborSurvey_Category", "VZZ_CostClass", "VZZ_WorkType",
    "Project_Status", "CapEx_Eligible_Pct", "ActualSpend_USD", "Hours_Logged",
    "Milestones_Completed", "DriveTests_Completed", "Asset_Life_Years",
    "Team", "Engineer_ID", "Quarter",
    # HR profile fields injected by enrichment pipeline
    "hr_job_title", "hr_job_family", "hr_org_unit", "hr_department",
    "hr_cost_centre", "hr_seniority", "hr_employee_type", "hr_location",
)
    ...
    try:
        ...
        if precomp:
            ...
            if skip_llm:
                ...
                llm_response = LLMResponse(provider="stub", model="local-stub", content=_llm._stub_combined(raw_context))
            else:
        ...
        step = {
            ...
            "status": "completed" if llm_provider != "stub" else "fallback",
